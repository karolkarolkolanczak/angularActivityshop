...
export class ProductsService {
  ...
  getLastProductId(): number {
    let lastProductId: number = this.productList[this.productList.length - 1].productId;
    console.log("Last Id: " + lastProductId + " " + this.productList[this.productList.length - 1].name);
